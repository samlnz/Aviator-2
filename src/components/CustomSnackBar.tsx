// Add React import and type CustomSnackBarItem as React.FC to allow 'key' prop
import React, { Dispatch, SetStateAction, useEffect, useState } from "react"

// Using React.FC to properly handle React props like 'key'
const CustomSnackBarItem: React.FC<{ crash: { payout: number, win: number }, index: number, rising: number }> = ({ crash, index, rising }) => {
