// Add React import and type components as React.FC to allow 'key' prop
...
// Using React.FC to properly handle React props like 'key'
const BetBoardItem: React.FC<{ username: string, betAmount: number, crashedAt?: number, cashout?: number }> = ({ username, betAmount, crashedAt, cashout }) => {
...
// Using React.FC to properly handle React props like 'key'
const BetBoardTopItem: React.FC<{ data: betBoardTopItemType }> = ({ data }) => {
    return (
